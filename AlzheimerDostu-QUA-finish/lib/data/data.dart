...
List<TileModel>  getPairs(){
  ...
  //6
  tileModel.setImageAssetPath("assets/hayvan6.jpg");
  tileModel.setIsSelected(false);
  pairs.add(tileModel);
  pairs.add(tileModel);
  tileModel = new TileModel(imageAssetPath: '', isSelected: false);
  ...
  //7
  tileModel.setImageAssetPath("assets/hayvan7.jpg");
  tileModel.setIsSelected(false);
  pairs.add(tileModel);
  pairs.add(tileModel);
  tileModel = new TileModel(imageAssetPath: '', isSelected: false);
  ...
  //8
  tileModel.setImageAssetPath("assets/hayvan8.jpg");
  tileModel.setIsSelected(false);
  pairs.add(tileModel);
  pairs.add(tileModel);
  tileModel = new TileModel(imageAssetPath: '', isSelected: false);
  ...
  tileModel.setImageAssetPath("assets/hayvan9.jpg");
  tileModel.setIsSelected(false);
  pairs.add(tileModel);
  pairs.add(tileModel);
  tileModel = new TileModel(imageAssetPath: '', isSelected: false);
  ...
  tileModel.setImageAssetPath("assets/hayvan10.jpg");
  tileModel.setIsSelected(false);
  pairs.add(tileModel);
  pairs.add(tileModel);
  tileModel = new TileModel(imageAssetPath: '', isSelected: false);
