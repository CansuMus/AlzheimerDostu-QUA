...
final List<Onboard> demo_data = [
  Onboard(
      ...
      desc:
          "Hasta Yakını Bölümünde hastanızın konumunu görebilir,bilgilerini bakabilir,mesaj atabilir ve kendiniz için not tutabilirsiniz "),
  Onboard(
      img: "assets/images/Hasta_onboarding.png",
      desc:
          "Hasta Bölümünde ise Kişi kendi bilgilerine acil bir durumda ulaşabilir, eğer kaybolursa evine navigasyon bölümünden evine gidebilir, ve acil bir durumda yakınını arayabilir"),
];
